        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <div className="py-6 px-4 space-y-8">
            ...
            <div className="mt-6">
              ...
              >
                {['Dream', 'Normal', 'Standard'].map((tier, index) => (
                  <div key={tier} className="flex items-center space-x-2">
                    <RadioGroupItem value={tier.toLowerCase()} id={`r${index + 1}`} />
                    <Label htmlFor={`r${index + 1}`} className="text-sm font-medium text-gray-700">
                      {tier}
                    </Label>
                  </div>
                ))}
...
<div className="bg-white p-8 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col min-w-[200px]">
          ...
          className="space-y-2">
            {['na','yes', 'no'].map((baoption,index) => (
              <div key={baoption} className="flex items-center space-x-2">
                <RadioGroupItem value={baoption.toLowerCase()} id={`r${index + 1}`}/>
                <Label htmlFor={`r${index + 1}`} className="text-sm font-medium text-gray-700">
                  {baoption}
                </Label>
              </div>
        ...
        <div className="flex flex-col min-w-[200px]">
          ...
          className="space-y-2"
             aria-label="Gender"
          >
            {[ 'all','male', 'female'].map((goption,index) => (
              <div key={goption} className="flex items-center space-x-2">
                <RadioGroupItem value={goption.toLowerCase()} id={`r${index + 1}`} />
                <Label htmlFor={`r${index + 1}`} className="text-sm font-medium text-gray-700">
                  {goption}
                </Label>
              </div>
